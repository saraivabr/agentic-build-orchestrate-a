    ...
    <div className="bg-[#F5F4F0] text-[#111] min-h-screen font-sans antialiased">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 z-30 flex flex-col px-6 md:px-12 pb-12 max-w-3xl">
          ...
          >
            Crie e<br />orquestre agentes<br />de IA enquanto<br />você dorme.
          </h1>

          {/* 3 metrics — staggered after title */}
          <div className="flex gap-8 sm:gap-12">
            {[
              { value: "50M+", label: "Tarefas" },
          ...
          <div className="grid grid-cols-12 grid-rows-auto gap-3" onMouseMove={handleMouse}>
            ...
            <BentoCard className="col-span-12 p-8 min-h-[200px] flex flex-col justify-between relative overflow-hidden" delay={0}>
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-light mb-3">Construtor visual de agentes</h3>
                <p className="text-sm text-black/45 leading-relaxed max-w-sm">
                  Arraste, conecte e configure agentes em um editor visual intuitivo. Sem boilerplate. Lance em minutos, não em dias.
                </p>
              </div>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={120}>
              ...
              <h3 className="text-lg font-light mb-2">Monitoramento em tempo real</h3>
              <p className="text-sm text-black/45 leading-relaxed">Rastreie cada decisão. Depure com histórico completo de execução e logs ao vivo.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={160}>
              ...
              <h3 className="text-lg font-light mb-2">Memória e contexto</h3>
              <p className="text-sm text-black/45 leading-relaxed">Memória persistente de longo prazo entre sessões. Os agentes aprendem com cada interação.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={200}>
              ...
              <h3 className="text-lg font-light mb-2">Guardrails e permissões</h3>
              <p className="text-sm text-black/45 leading-relaxed">Defina o que os agentes podem e não podem fazer. Controle de acesso granular por ferramenta.</p>
            </BentoCard>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              ...
              <div className="mt-4"><Tag>TIPOS DE AGENTE</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
                {"Agentes plug-and-play\nprontos para publicar."}
              </RevealText>
            </div>
            <p className="text-sm text-black/45 leading-relaxed max-w-xs">
              Comece com um agente pronto ou monte o seu com componentes básicos. Todo agente é versionado, testável e observável.
            </p>
          </div>
      ...
      <section id="workflow" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <div className="mt-4"><Tag>FLUXO</Tag></div>
            <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
              {"Da ideia ao agente rodando\nem quatro etapas."}
            </RevealText>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-3" onMouseMove={handleMouse}>
            {[
              { n: "01", title: "Definir",  desc: "Descreva seu agente em linguagem natural. Defina objetivos, ferramentas e limites.", delay: 0,   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/define-5aafAmGBrxZpOqJ3XLHY3n3qzC2I5K.png" },
              { n: "02", title: "Compor", desc: "Encadeie agentes no editor visual. Conecte gatilhos, condições e saídas.", delay: 80,  img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/compose-5RT5VR4f1Y3GoFmovqTKLTG4UXp3g2.png" },
              { n: "03", title: "Testar",   desc: "Rode simulações em sandbox. Inspecione cada decisão no trace de execução.", delay: 140, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/test-zm8guZwxJHtwWsJ7XO4B0CF7GzlNK8.png" },
              { n: "04", title: "Publicar", desc: "Publique globalmente com um clique. Agentes escalam, se recuperam e reportam automaticamente.", delay: 200, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/deploy-an8fgHSLzniojkcmRyGGIFQUJF9T5J.png" },
            ].map((step) => (
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              ...
              <div className="mt-4"><Tag>INTEGRAÇÕES</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
                {"Conecte qualquer ferramenta.\nControle qualquer sistema."}
              </RevealText>
            </div>
            <p className="text-sm text-black/45 leading-relaxed max-w-xs">
              Mais de 200 conectores nativos. De Slack ao seu banco interno. Crie ferramentas personalizadas com nosso SDK em minutos.
            </p>
          </div>
          ...
          <div className="rounded-2xl overflow-hidden border border-black/[0.07] flex flex-col md:block md:relative" onMouseMove={handleMouse}>
            ...
            <div className="relative w-full h-[280px] md:h-[480px] shrink-0">
              <img
                ...
                alt="Arquitetura de orquestração de agentes"
            ...
            <div className="flex flex-col gap-3 p-4 md:absolute md:bottom-4 md:right-4 md:p-0 md:w-72">
              ...
              >
                <Tag>SDK</Tag>
                <h3 className="mt-3 text-lg font-light mb-2">Criar ferramentas personalizadas</h3>
                <p className="text-xs text-black/45 leading-relaxed mb-4">Defina qualquer função como uma ferramenta que seus agentes podem chamar. TypeScript e Python.</p>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-black/40 tracking-widest">API AO VIVO</span>
                </div>
                <p className="text-sm text-black/45">API completa REST + WebSocket. Transmita saídas de agentes direto no seu produto.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="security" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            <PixelIcon type="platform" size={40} />
            <div className="mt-4"><Tag>SEGURANÇA</Tag></div>
            <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <p className="text-sm text-black/45 leading-relaxed">
                Toda ação é registrada, toda decisão é rastreável. Feito para equipes que precisam de compliance sem compromissos.
              </p>

              <div className="space-y-4">
                {[
                  { label: "SOC 2 Tipo II", desc: "Controles de segurança auditados de forma independente" },
                  { label: "Trilha completa de auditoria", desc: "Toda decisão registrada com rastreabilidade total" },
                  { label: "Observabilidade em tempo real", desc: "Monitore, depure e reproduza qualquer execução" },
                ].map((item) => (
              ...
              <div className="pt-4 flex flex-col gap-2">
                {["SOC 2", "GDPR", "Pronto para HIPAA", "ISO 27001"].map((badge) => (
            ...
            <BentoCard className="p-6 lg:row-span-1" delay={0}>
              <div className="text-xs text-black/30 tracking-widest uppercase mb-4">Trilha de auditoria ao vivo</div>
              <div className="space-y-2">
                {[
                  { time: "12:34:21", action: "agent_executed", status: "sucesso" },
                  { time: "12:34:18", action: "decision_logged", status: "sucesso" },
                  { time: "12:34:15", action: "tool_called", status: "sucesso" },
                  { time: "12:34:12", action: "memory_updated", status: "sucesso" },
                  { time: "12:34:09", action: "output_generated", status: "sucesso" },
                ].map((log, i) => (
                  <div
                    key={i}
      ...
      <section className="py-0 border-t border-black/[0.06] overflow-hidden select-none">
        <div className="flex border-b border-black/[0.06]" style={{ animation: "marqueeLeft 28s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Pesquisa web", "Geração de código", "Rascunho de e-mails", "Análise de dados", "Revisões de PR", "Agendamento", "Consultas SQL", "Chamadas de API", "Processamento de arquivos", "Monitoramento"].map((cap) => (
        ...
        <div className="flex" style={{ animation: "marqueeRight 22s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Escrita de relatórios", "Resumos de Slack", "Pontuação de leads", "Classificação de imagens", "Execução de testes", "Deploy", "Análise de logs", "Processamento de faturas", "Notas de reunião", "Análise de sentimento"].map((cap) => (
                <div key={cap} className="flex items-center gap-6 px-10 py-5 border-r border-black/[0.06] shrink-0">
      ...
      <section id="live" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <PixelIcon type="agents" size={40} />
              <div className="mt-4"><Tag>AO VIVO AGORA</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.05]">
                {"Agentes trabalhando\n24 / 7, de forma autônoma."}
              </RevealText>
              <p className="mt-6 text-base text-black/40 leading-relaxed max-w-sm">
                A qualquer momento, milhares de agentes executam tarefas para equipes ao redor do mundo — sem intervenção humana.
              </p>
              <div className="mt-10 flex items-end gap-2">
                <LiveAgentCounter />
                <span className="text-black/30 text-sm mb-1 tracking-wide">agentes ativos globalmente</span>
              </div>
            </div>
      ...
      <section id="pricing" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16 flex flex-col items-center">
            ...
            <div className="mt-4"><Tag>PREÇOS</Tag></div>
            <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
              {"Pague conforme seus agentes crescem."}
            </RevealText>
          </div>
            ...
            {[
              {
                name: "Teste",
                price: "Grátis",
                sub: "Comece a experimentar",
                features: ["5 agentes", "1.000 tarefas/mês", "Suporte da comunidade", "Traces básicos"],
                delay: 0,
              },
              {
                name: "Construtor",
                price: "$49",
                period: "/mo",
                sub: "Para equipes que entregam rápido",
                features: ["50 agentes", "100 mil tarefas/mês", "Suporte prioritário", "Traces completos + replay", "Ferramentas personalizadas", "API REST"],
                highlight: true,
                delay: 80,
              },
              {
                name: "Empresarial",
                price: "Personalizado",
                sub: "Para organizações em escala",
                features: ["Agentes ilimitados", "Tarefas ilimitadas", "Infra dedicada", "SOC 2 / HIPAA", "Garantias de SLA", "Contratos personalizados"],
                delay: 140,
              },
            ].map((plan) => (
              <BentoCard
              ...
              >
                ...
                <button className={`w-full py-3 rounded-xl text-sm tracking-widest transition-all duration-200 ${
                  ...
                  {plan.name === "Empresarial" ? "FALE COM VENDAS" : "COMEÇAR"}
                </button>
              </BentoCard>
            ))}
          </div>
      ...
      <section className="relative py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.05] mb-6">
            Comece a montar sua<br />força de trabalho de agentes.
          </h2>
          <p className="text-sm text-black/45 leading-relaxed mb-10">
            Junte-se a milhares de equipes que implantam agentes de IA que trabalham 24 horas por dia, em todos os fusos horários.
          </p>
          {!submitted ? (
            <form
      ...
      <footer className="py-10 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-black/[0.04]">
          <span className="text-xs text-black/20">© 2026 Agentic. Todos os direitos reservados.</span>
        </div>
      </footer>
    </div>
  )
