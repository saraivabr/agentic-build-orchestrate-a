...
const AGENTS = [
  {
    label: "RESEARCHER",
    title: "Pesquisa web e dados",
    desc: "Navega na web de forma autônoma, extrai dados estruturados e sintetiza relatórios de múltiplas fontes com citações.",
    stats: [{ v: "2.4M", l: "tarefas executadas" }, { v: "98.2%", l: "precisão" }],
  ...
  },
  {
    ...
    desc: "Escreve, refatora e revisa código em mais de 40 linguagens. Executa testes, corrige bugs e abre pull requests automaticamente.",
    stats: [{ v: "1.1M", l: "PRs mesclados" }, { v: "3.2s", l: "resposta média" }],
  ...
  },
  {
    ...
    desc: "Conecta aos seus bancos de dados, roda consultas, visualiza tendências e identifica anomalias antes que virem problemas.",
    stats: [{ v: "880K", l: "relatórios" }, { v: "12x", l: "mais rápido" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/analyst-Ysxnqg7Fpy2cfA56PiIttv1KximMhT.png",
  },
  {
    label: "EXECUTOR",
    title: "Automação de fluxos",
    desc: "Executa ações via APIs: envia mensagens, cria eventos no calendário, dispara webhooks e gerencia apps de terceiros.",
    stats: [{ v: "5.6M", l: "execuções" }, { v: "99.9%", l: "disponibilidade" }],
